...
generate_prompts <- function(treated_cols, wt_cols) {
  ...
  prompts <- c(
    ...
    sprintf("compare columns %s (treated) with columns %s (control), show up regulated", treated_cols, wt_cols),
    ...
    sprintf("perform differential gene expression analysis between treatment group (samples %s) and control group (samples %s), focus on up regulated genes", treated_cols, wt_cols),
    sprintf("make the comparison of the treated patients %s against wt ones %s, only down regulated genes", treated_cols, wt_cols),
    sprintf("calculate significant differential genes between treatment samples (samples %s) and control ones (samples %s), expecially up regulated genes", treated_cols, wt_cols),
    sprintf("do the analysis of the %s treated and of the %s control. I want the up regulated genes only", treated_cols, wt_cols),
